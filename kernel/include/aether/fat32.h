...
#define FAT32_MAX_FILES     32     /* simultaneous open file handles */
...
int  fat32_open   (const char *path);               /* returns handle 0..31 or -1 */
...
int  fat32_create (const char *path);               /* returns handle 0..31 or -1 */
