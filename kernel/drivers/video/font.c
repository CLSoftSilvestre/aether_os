/*
 * AetherOS — Embedded 8×8 Bitmap Font
 * File: kernel/drivers/video/font.c
 *
 * Public-domain VGA 8×8 font (IBM CP437 subset, glyphs 0x00–0xFF).
 * Each glyph is 8 bytes; bit 7 of each byte is the leftmost pixel.
 *
 * Source: derived from the classic PC BIOS 8×8 font (public domain).
 */
...
/* 256 glyphs × 8 bytes/glyph = 2048 bytes */
static const u8 font8x8[256][8] = {
    ...
    /* 0x35 */ {0xFE,0xC0,0xC0,0xFC,0x06,0xC6,0x7C,0x00}, /* 5 */
    ...
    /* 0x41 */ {0x10,0x38,0x6C,0xC6,0xFE,0xC6,0xC6,0x00}, /* A */
    ...
    /* 0x55 */ {0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0x78,0x00}, /* U */
    ...
    /* 0x7F–0xFF: fill with a solid block glyph */
